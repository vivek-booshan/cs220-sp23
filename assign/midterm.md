...
<li><strong>Due: <s>Friday, March 17th</s> Monday, March 27th at 11pm EST (Baltimore time).</strong></li>
...
course public repository (e.g., `cd ~/cs220-sp23-public`), and run the command
